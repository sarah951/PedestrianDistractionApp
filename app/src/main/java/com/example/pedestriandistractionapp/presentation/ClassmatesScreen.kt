...
//
//@Composable
//fun ClassmatesScreen(navController: NavHostController) {
//    Column(
//        modifier = Modifier
//            .fillMaxSize()
...
//    ) {
//        Image(
//            painter = painterResource(id = R.drawable.ic_classmates),
//            contentDescription = "Classmates Icon",
    ...
    Box(
        ...
        Image(
            ...
            modifier = Modifier
                ...
                .clickable {
                    navController.navigate("teammates_screen")
                }
        )
    }
}
